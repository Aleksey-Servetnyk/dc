...
open class DcWebTestContainer : TestContainer() {
    ...
    init {
        ...
        appPropertiesFiles = Arrays.asList( // List the files defined in your web.xml
                ...
                "com/company/dc/web-app.properties",  // Add this file which is located in CUBA and defines some properties
    ...
    class Common private constructor() : DcWebTestContainer() {
